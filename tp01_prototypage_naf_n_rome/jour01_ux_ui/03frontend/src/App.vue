<template>
  <div class="min-h-screen bg-slate-50">
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-slate-500 mt-0.5">
              ...
              <span class="ml-2 text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full font-medium">
                Source : CSV local — Jour 1
              </span>
            </p>
          </div>
      ...
      <div v-if="error" class="bg-red-50 border border-red-200 rounded-xl p-4 text-red-700 text-sm flex items-start gap-3">
        ...
        <div>
          ...
          <p class="mt-1 text-xs text-red-500">
            Vérifiez que le fichier <code class="bg-red-100 px-1 rounded">public/data/sample_naf_rome.csv</code> existe.
          </p>
        </div>
      </div>
    ...
    <footer class="text-center py-6 text-xs text-slate-400">
      TP 1.0 · Master IA · CreativeTech · Sources : INSEE &amp; data.gouv.fr
    </footer>
  </div>
</template>
